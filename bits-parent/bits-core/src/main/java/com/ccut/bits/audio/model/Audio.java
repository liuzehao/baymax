package com.ccut.bits.audio.model;
...
public class Audio {
    ...
    String fileSize;
    String fileImgUrl;
String fileNameFormer;

    public String getFileNameFormer() {
        return fileNameFormer;
    }

    public void setFileNameFormer(String fileNameFormer) {
        this.fileNameFormer = fileNameFormer;
    }
