                ...
                <div class="col-md-12">
                    <div class="portlet box">
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="#" class="form-horizontal" id="editFrom">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input id="oldPermTokens" name="oldPermTokens" type="hidden"
...
<script type="text/javascript">
    ...
    var zNodes = [
        <c:forEach var="MenuPerm" items="${menuPermList}">
        {
            ...
            name: "${MenuPerm.menuName}",
            permToken: "${MenuPerm.permToken}",
            checked: "${MenuPerm.checked}"
        },
        </c:forEach>
    ];
