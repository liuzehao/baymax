...
<head>
    ...
    <script src="<c:url value="/js/user/GeneralFilePage.js"/>"></script>
        ...
        <div class="row margin-bottom-40">
            <div class="sidebar col-md-2 col-sm-2">
                <ul class="list-group margin-bottom-25 sidebar-menu">
                    ...
                    <li id="li3" class="list-group-item clearfix" style="background-color:#88ABC9;text-align: center"><a href="handleGeneral" style="color: #fff;font-size: 16px;">常用文档 <i class="fa fa-caret-right"></i></a></li>
                    ...
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa  fa-folder-open-o"></i>我的常用
                                </div>
                            </div>
                            <div class="portlet-body">

                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="datatable_ajax" style="text-align: center">
                                        <col width="15%">
                                        <col width="25%">
                                        <col width="25%">
                                        <col width="25%">
            ...
            <div class="modal-dialog" style="width: 700px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="portlet-body">
                            <iframe id="literatureEditIframe" style="border: none;width:650px;height:750px;" frameBorder="0"></iframe>
                        </div>
                    </div>
                </div>
                <!-- /.modal-content -->
