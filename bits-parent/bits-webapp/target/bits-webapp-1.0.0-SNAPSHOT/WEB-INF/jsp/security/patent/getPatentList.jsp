...
<head>
    ...
    <script src="<c:url value="/js/admin/systemPatent.js"/>"></script>
</head>
<body>
        ...
        <div class="page-sidebar-wrapper">
                <div class="page-sidebar navbar-collapse collapse" style="margin-top:50px">
                    <jsp:include page="../../includes/menu.jsp">
                        <jsp:param name="systemNum" value="5"/>
                    </jsp:include>
                </div>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-comments"></i>专利管理
                                </div>
                                <div class="actions">
                                    <a class="btn btn-default" data-toggle="modal" onclick="patentListTable.addPatentInfo()" id="add">
                                        <i class="fa fa-plus faa-shake animated-hover"></i>新增</a>
                                    <a onclick="patentListTable.refresh()" class="btn btn-default"><i
                                ...
                                <div style="text-align:right">
                                    <form id="query">
                                        ...
                                        <a class="btn btn-xs btn-default blue" style="height:25px"
                                           onclick="patentListTable.search()">
