...
<head>
    ...
    <script src="<c:url value="/js/admin/systemExpert.js"/>"></script>
</head>
<body>
                    ...
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-comments"></i>专家管理
                                </div>
                                <div class="actions">
                                    <a class="btn btn-default" data-toggle="modal" onclick="expertListTable.addExpertInfo()" id="add">
                                        <i class="fa fa-plus faa-shake animated-hover"></i>新增</a>
                                    <a onclick="expertListTable.refresh()" class="btn btn-default"><i
                                ...
                                <div style="text-align:right">
                                    <form id="query">
                                        ...
                                        <a class="btn btn-xs btn-default blue" style="height:25px"
                                           onclick="expertListTable.search()">
