    ...
    return {
        ...
        init: function (options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    "dom": "<'row'<'col-md-4 col-sm-12'<'table-group-actions pull-right'>>r><'table-scrollable't><'row'<'col-md-8 col-sm-12'pli><'col-md-4 col-sm-12'>r>", // datatable layout
                    ...
                    "oLanguage": {  // language settings
                        ...
                        "emptyTable": "表格中无可用数据",
                        "zeroRecords": "未找到匹配记录",
                        "sInfoEmpty": "显示 0 到 0 条记录 总记录数为 0",
                        "sEmptyTable": "您的文件列表为空",
                        "oPaginate": {
                            "sPrevious": "上一页",
                            "sNext": "下一页",
                            "sPage": "第",
